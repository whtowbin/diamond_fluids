...
sns.scatterplot(df, y = "Zr/La", x= "Pb/U", hue = "Locality ", ax = ax)
...
fig, ax = plt.subplots()
sns.scatterplot(df, y = "La/Ce", x= "Ba/Ce", hue = "Locality ", ax = ax)
...
#%%
fig, ax = plt.subplots()
sns.scatterplot(df, y = "Nb/La", x= "Zr/Sr", hue = "Locality ", ax = ax)
#ax.set_xbound(0,100)
# ax.set_ybound(0,20)
plt.yscale('log')
plt.xscale('log')
...
filtered_col = [ "Nb/La", "Zr/Sr", "Zr/La", "Rb/Sr", "Ba/Sr", "U/Sr", "Ba/Ce", "La/Ce", "Pb/U", "Y/La", "Zr/Y", "Zr/Nb", "Nb/La",]# "Al/La", "Mg/La", "Mg/Sr"]
df_filtered = df[filtered_col].dropna()
df_filtered.head()
Locality = df.loc[df_filtered.index]["Locality "]
...
Classification_Comp = pd.DataFrame({"Locality":Locality, "Clusters": y_pred})
...
fig, ax = plt.subplots()
sns.scatterplot(Classification_Comp, y = "Rb/Sr", x= "Zr/La", hue = "Locality", ax = ax)
...
fig, ax = plt.subplots()
sns.scatterplot(Classification_Comp, y = "Ba/Ce", x= "La/Ce", hue = "Locality", ax = ax)

plt.yscale('log')
plt.xscale('log')
# %%
#plot_order = ["saline", 'silicic', 'silicic - low-Mg carbonatitic', 'low-Mg carbonatitic','high-Mg carbonatitic'  ]
sns.catplot(Classification_Comp, x  = "Locality", y = "Clusters" , alpha = 0.2, size = 10 )
plt.xticks(rotation=30)

pivot_table = Classification_Comp.pivot_table(index='Locality', columns='Clusters', aggfunc='size', fill_value=0)
pivot_table
# %%
